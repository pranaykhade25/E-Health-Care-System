...
<body>
<% String user1=(String)session.getAttribute("b"); %>
<p><h2>Welcome!! &emsp; &emsp;<%=session.getAttribute("b") %></h2>
<div class="tab">
  <button class="tablinks" onclick="openCity(event, 'Profile')" id="defaultOpen">My Account</button>
  <button class="tablinks" onclick="openCity(event, 'Appointments')">My Appointments</button>
           ...
           <tr> <th>Doctor Name</th>
            ...
            <th>Email</th>
				...
				<form method="POST">
                            ...
                            ResultSet rs;
                            rs = st.executeQuery("select * from doctor where email='"+user1+"'");
                            while (rs.next()) {
           ...
           <tr> <th>Patient Name</th>
            ...
            <th>Status</th>
				...
				<form method="POST">
                            ...
                            ResultSet rs1;
                            rs1 = st1.executeQuery("select pname,pemail,department from patient,appointment where patient.email=appointment.pemail and demail='"+user1+"'");
                            while (rs1.next()) {
...
document.getElementById("defaultOpen").click();
 ...
 <a href='DoctLogout.jsp'>Log out</a>
</body>
</html>